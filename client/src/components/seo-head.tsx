...
export function SEOHead({
  title = "Si Viaggia con Desi - Escursioni a Sharm El Sheikh",
  description = "✈️ Si Viaggia con Desi - Il tuo tour operator di fiducia a Sharm El Sheikh. Escursioni Mar Rosso, safari deserto, diving, snorkeling. Esperienze uniche in Egitto.",
