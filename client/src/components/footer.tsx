      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-2">
            <div className="text-2xl font-bold mb-4 flex items-center text-primary">
              <Home className="mr-2 h-6 w-6" />
              AGENZIA 2 Servizi Immobiliari
            </div>
            <p className="text-gray-300 mb-2 max-w-md">
              <span className="text-accent font-medium">Geometra Antonio Cannavò</span>
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="/servizi" className="hover:text-accent transition-colors">Perizie Immobiliari</a></li>
              <li><a href="/servizi" className="hover:text-accent transition-colors">Servizi Legali</a></li>
              <li><a href="/servizi" className="hover:text-accent transition-colors">Compravendita</a></li>
              <li><a href="/servizi" className="hover:text-accent transition-colors">Mutui Agevolati</a></li>
              <li><a href="/servizi" className="hover:text-accent transition-colors">A.P.E. Certificazioni</a></li>
            </ul>
          </div>
