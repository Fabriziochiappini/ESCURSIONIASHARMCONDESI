    ...
    <section className="py-20 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 pattern-dots relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4 gold-title tracking-[0.15em] uppercase drop-shadow-lg font-eagle-lake">
            Le nostre foto
          </h2>
              ...
              <Link key={gallery.id} href="/galleria">
                ...
                >
                  ...
                  <div className="text-center space-y-2">
                    <h3 className="text-2xl font-bold gold-title tracking-wide group-hover:scale-105 transition-transform font-eagle-lake">
                      {gallery.title}
                    </h3>
                    {gallery.description && (
